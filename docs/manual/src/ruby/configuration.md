...
# Library mode already maps every peer crate to UpperCamelCase(namespace); this is only needed
# when that default is wrong. Keys are crate names, not namespaces.
