...
understands and that is safe to expose to other languages.
...
mod sprites {
  ...
  // These are used to communicate structure data back-and-forth with foreign-language code.
  ...
  // method implementations. These are used to represent objects with encapsulted
